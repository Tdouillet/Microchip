...
SOURCEFILES_QUOTED_IF_SPACED=APPLICATION/app.c DRIVERS/lidar.c HARDWARE/UART_LIDAR.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/APPLICATION/app.p1 ${OBJECTDIR}/DRIVERS/lidar.p1 ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/APPLICATION/app.p1.d ${OBJECTDIR}/DRIVERS/lidar.p1.d ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/APPLICATION/app.p1 ${OBJECTDIR}/DRIVERS/lidar.p1 ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1

# Source Files
SOURCEFILES=APPLICATION/app.c DRIVERS/lidar.c HARDWARE/UART_LIDAR.c
...
${OBJECTDIR}/HARDWARE/UART_LIDAR.p1: HARDWARE/UART_LIDAR.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/HARDWARE" 
	@${RM} ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1.d 
	@${RM} ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1 HARDWARE/UART_LIDAR.c 
	@-${MV} ${OBJECTDIR}/HARDWARE/UART_LIDAR.d ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/HARDWARE/UART_LIDAR.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
